...
fn known_buffer_size_for_ffi_type(tpe: ffi::enum_field_types) -> Option<libc::c_ulong> {
    ...
    match tpe {
        enum_field_types::MYSQL_TYPE_TINY => Some(1),
        enum_field_types::MYSQL_TYPE_YEAR |
        enum_field_types::MYSQL_TYPE_SHORT => Some(2),
        enum_field_types::MYSQL_TYPE_INT24 |
        enum_field_types::MYSQL_TYPE_LONG |
        enum_field_types::MYSQL_TYPE_FLOAT => Some(4),
        enum_field_types::MYSQL_TYPE_LONGLONG |
        enum_field_types::MYSQL_TYPE_DOUBLE => Some(8),
